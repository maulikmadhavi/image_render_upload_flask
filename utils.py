...
#                 model_id, trust_remote_code=True, device_map="cuda:0"
#             )
#             .eval()
#             .cuda()
#             .half()
...
#         return self.run_example("<MORE_DETAILED_CAPTION>", img)[
...
#         caption_dict = {}
#         for i in tqdm(
#             range(fps // 2, len(self.vr), time_step * fps),
#             desc="Processing frames",
#             total=len(self.vr) // fps,
#         ):
...
#     vp = VideoProcessor(
#         "/home/maulik/Documents/Tool/Coding_practice/flask_image_summarizer/static/renames/2024-10-14_00-33-55.mp4"
#     )
#     vp.get_caption()
